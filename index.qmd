...
par(mfcol = c(1, 1), mar = c(4, 2, 2, 2))
ggplot(data_df, aes(x = Index)) +
  annotate("rect", xmin = min(data_df$Index), xmax = max(data_df$Index), 
           ymin = 2, ymax = 3, fill = blue2, alpha = 0.5) +
  geom_line(aes(y = inf_data, colour = "Inflation Rate")) +
  geom_line(aes(y = infexp_data, colour = "Expected Inflation Rate")) +
  scale_color_manual(name = "",
                     values = c("Inflation Rate" = blue1, "Expected Inflation Rate" = blue4)) +
  labs(title = "Inflation Rate vs Expected Inflation Rate", x = "Date", y = "Rate (%)") +
  theme_minimal() +
...
hist(posterior.extend.draws[["A.posterior.exten"]][2,1,], xlab = "CPI", col = blue2, main = '')
hist(posterior.extend.draws[["A.posterior.exten"]][2,2,], xlab = "Inflation Expectation", col = blue2, main = '')
hist(posterior.extend.draws[["A.posterior.exten"]][2,6,], xlab = "M3", col = blue2, main = '')


hist(posterior.extend.draws[["Sigma.posterior.exten"]][1,1,], xlab = "CPI sigma", col = green2, main = '')
hist(posterior.extend.draws[["Sigma.posterior.exten"]][1,2,], xlab = "Inflation Expectation sigma", col = green2, main = '')
hist(posterior.extend.draws[["Sigma.posterior.exten"]][1,6,], xlab = "M3 sigma", col = green2, main = '')
```

Figure 7 Model Simulation of Extend Model

```{r Extension Model lambda Plot}
#| echo: false
#| message: false
#| warning: false
par(mfcol = c(1, 2), mar = c(4, 2, 14, 2))
