...
-   **Economic Activity and Policy Indicators:**
    ...
    6.  $m_i$: M2 Money aggregate from RBA.
...
According to Table 1, we can see that $labn_i$, $lexport_i$, require more than first order integration, while other require first-order integration(under 5% level of confidence).
...
Unit_Root_Test_table <- 
  tibble( " " = c("lcpi", "lgold", "lgdp", "crt", "unemp", "labn", "lexport","limport", "laord", "exr"),
