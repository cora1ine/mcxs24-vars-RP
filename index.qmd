...
$$y_t = \mu_0 + A_1y_{t-1} +...+A_py_{t-p} +\epsilon_t \\ \epsilon_t|Y_{t-1} \sim iid \mathcal{N}_{10}(\textbf{0}_{10}, \Sigma)$$ {#eq-2}

In matrix notation:

$$Y = X A +E \\ E|X\sim \mathcal{MN}_{T\times 10}(\textbf{0},\Sigma,I_T)$$ {#eq-3}
...
\Sigma &\sim \mathcal{IW}_{N}(\underline{S},\underline{v})\\
\lambda &\sim \mathcal{Gamma}(\underline{S_{\lambda}}, \underline{v_{\lambda}} ) \\ 
\end{align}
$$
