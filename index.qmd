...
```{r Mean Sigma of Basic Model, fig.align='center',fig.pos='H'}
#| echo: false
#| message: false
#| warning: false
# Presenting output
A.posterior.simu.mean = head(round(apply(A.posterior.simu, 1:2, mean), 6),11)
Sigma.posterior.simu.mean = round(apply(Sigma.posterior.simu, 1:2, mean),6)      
```


```{r Mean Sigma of Basic Model Output1, fig.align='center',fig.pos='H'}
#| echo: false
#| message: false
#| warning: false
#| tbl-cap: "Table 6 Mean Values of A.posterior.simu (head 11)"
...
```{r Mean Sigma of Basic Model Output2, fig.align='center',fig.pos='H'}
#| echo: false
#| message: false
#| warning: false
#| tbl-cap: "Table 7 Mean Values of Sigma.posterior.simu"
...
```{r Histograms Trace Plots Basic, fig.align='center',fig.pos='H'}
#| echo: false
#| message: false
#| warning: false
...
plot.ts(A.posterior.simu[2,1,], xlab = "Simulation times S", ylab = "lcpi", col = blue3) 
hist(A.posterior.simu[2,1,], xlab = "lcpi", col = blue3, main = '')
plot.ts(A.posterior.simu[2,2,], xlab = "Simulation times S", ylab = "infexp", col = green3) 
hist(A.posterior.simu[2,2,], xlab = "infexp", col = green3, main = '')
...
```{r 3d Forecasting Graph on Basic, fig.align='center',fig.pos='H'}
#| echo: false
#| message: false
#| warning: false
#| fig-cap: "Figure 7 3D forecasting graph on basic model"
...
```{r 2d Forecasting Graph on Basic, fig.align='center',fig.pos='H'}
#| echo: false
#| message: false
#| warning: false
#| fig-cap: "Figure 2D forecasting graph on basic model"
...
```{r Basic Key Data Plot, fig.align='center',fig.pos='H'}
#| echo: false
#| message: false
#| warning: false
...
```{r Mean Sigma of Extended Model, fig.align='center',fig.pos='H'}
#| echo: false
#| message: false
#| warning: false

# Presenting output
A.posterior.ext.simu.mean = head(round(apply(A.posterior.ext.simu, 1:2, mean), 6),11)
Sigma.posterior.ext.simu.mean = round(apply(Sigma.posterior.ext.simu, 1:2, mean),6)      
```


```{r Mean Sigma of Extended Model Output1, fig.align='center',fig.pos='H'}
#| echo: false
#| message: false
#| warning: false
#| tbl-cap: "Table 8 Mean Values of A.posterior.ext.simu (head 11)"

kable(A.posterior.ext.simu.mean, align = "c") %>% 
  kable_styling(font_size = 8, 
                fixed_thead = TRUE, 
                full_width = FALSE, 
                position = "center",
...
```{r Mean Sigma of Extended Model Output2, fig.align='center',fig.pos='H'}
#| echo: false
#| message: false
#| warning: false
#| tbl-cap: "Table 9 Mean Values of Sigma.posterior.ext.simu"

kable(Sigma.posterior.ext.simu.mean, align = "c") %>% 
  kable_styling(font_size = 8, 
                fixed_thead = TRUE, 
                full_width = FALSE, 
                position = "center",
...
```{r Histograms Trace Plots Extended, fig.align='center',fig.pos='H'}
#| echo: false
#| message: false
#| warning: false
#| fig-cap: "Figure 9 Histograms and trace plots on key variables using extended model"

par(mfrow=c(2,2), mar=c(4,4,2,2))
plot.ts(A.posterior.ext.simu[2,1,], xlab = "Simulation times S", ylab = "lcpi", col = blue3) 
hist(A.posterior.ext.simu[2,1,], xlab = "lcpi", col = blue3, main = '')
plot.ts(A.posterior.ext.simu[2,2,], xlab = "Simulation times S", ylab = "infexp", col = green3) 
hist(A.posterior.ext.simu[2,2,], xlab = "infexp", col = green3, main = '')
...
```{r 3d Forecasting Graph on Extension, fig.align='center',fig.pos='H'}
#| echo: false
#| message: false
#| warning: false
#| fig-cap: "Figure 10 3d forecasting graph on extension model"

threed.ext.graph = threed.graph(Y.h = Y.h.ext)
```

```{r 2d Forecasting Graph on Extension, fig.align='center',fig.pos='H'}
#| echo: false
#| message: false
#| warning: false
#| fig-cap: "Figure  2d forecasting graph on extension model"
...
```{r Dist, fig.align='center',fig.pos='H'}
#| echo: false
#| message: false
#| warning: false
...
```{r Test, fig.align='center',fig.pos='H'}
#| echo: false
#| message: false
#| warning: false
...
As $\overline{A}$, $\overline{V}$, $\overline{S}$ and $\overline{v}$ are specified:
...
3. Draw the logarithmic volatilities $H$ using a function designed to handle tridiagonal precision matrices, incorporating both the prior on $h_0$ and the conditional distributions of the log-volatilities

4. Compute $\sigma^2$ from the exponential transformation of the drawn logarithmic volatilities $H$.

5.Draw $\sigma_v^2$ from the inverse gamma distribution, considering the sum of squared differences between successive $H$ values and $h0$

6. Update the State Variable $s$:
...
```{r Basic Heteroskedasticity Model, fig.align='center',fig.pos='H'}
#| echo: true
#| message: false
#| warning: false
...
A.posterior.het.simu       = posterior.hetero[["A"]]
Sigma.posterior.het.simu   = posterior.hetero[["Sigma"]]
Sigma2.posterior.het.simu  = posterior.hetero[["sigma2"]]
```


```{r Mean Sigma of Basic SV Model, fig.align='center',fig.pos='H'}
#| echo: false
#| message: false
#| warning: false

# Presenting output
A.posterior.het.simu.mean = head(round(apply(A.posterior.het.simu, 1:2, mean), 6),11)
Sigma.posterior.het.simu.mean = round(apply(Sigma.posterior.het.simu, 1:2, mean),6)    


```


```{r Mean Sigma of Basic SV Model Output1, fig.align='center',fig.pos='H'}
#| echo: false
#| message: false
#| warning: false
#| tbl-cap: "Table 10 Mean Values of A.posterior.het.simu (head 11)"

kable(A.posterior.het.simu.mean, align = "c") %>% 
  kable_styling(font_size = 8, 
                fixed_thead = TRUE, 
                full_width = FALSE, 
                position = "center",
...
```{r Mean Sigma of Basic SV Model Output2, fig.align='center',fig.pos='H'}
#| echo: false
#| message: false
#| warning: false
#| tbl-cap: "Table 11 Mean Values of Sigma.posterior.het.simu"

kable(Sigma.posterior.het.simu.mean, align = "c") %>% 
  kable_styling(font_size = 8, 
                fixed_thead = TRUE, 
                full_width = FALSE, 
                position = "center",
...
```{r Histograms Trace Plots Basic Hetero, fig.align='center',fig.pos='H'}
#| echo: false
#| message: false
#| warning: false
#| fig-cap: "Figure 14 Histograms and trace plots on key variables using basic hetero model"

par(mfrow=c(2,2), mar=c(4,4,2,2))
plot.ts(A.posterior.het.simu[2,1,], xlab = "Simulation times S", ylab = "lcpi", col = blue3) 
hist(A.posterior.het.simu[2,1,], xlab = "lcpi", col = blue3, main = '')
plot.ts(A.posterior.het.simu[2,2,], xlab = "Simulation times S", ylab = "infexp", col = green3) 
hist(A.posterior.het.simu[2,2,], xlab = "infexp", col = green3, main = '')
...
Y.h       = sampling.predictive.density.fun(A.posterior.simu = A.posterior.het.simu,
                                                Sigma.posterior.simu = Sigma.posterior.het.simu,
                                                S = S) 

```


Figure 11 displays a 3D visualization that, as anticipated, exhibits confidence intervals expanding from narrow to wide. Furthermore, the confidence intervals appear narrower than those in the model without heteroscedasticity, suggesting that incorporating heteroscedasticity is efficacious.


```{r 3d Forecasting Graph on Basic Hetero, fig.align='center',fig.pos='H'}
#| echo: false
#| message: false
#| warning: false
#| fig-cap: "Figure 15 3D forecasting graph on basic model with heteroskedasticity"
...
#| message: false
#| warning: false
#| fig-cap: "Figure 2D forecasting graph on basic model with heteroskedasticity"
...
As analyzed above, Figure 12 also shows improved forecasts, with the predicted inflation rate gradually declining to 2-3% over the next eight periods. Additionally, people's expectations of inflation are also decreasing in sync, aligning with the initial inquiry.

```{r Basic Model with hetero Key Data Plot, fig.align='center',fig.pos='H'}
#| echo: false
#| message: false
#| warning: false
#| fig-cap: "Figure 16 Basic Model with heteroskedasticity key data plot"

key.data.basic.hetero.graph = key.data.plot(key.data.h = key.data.h)
```


### Extended Model with Heteroskedasticity
...
```{r eigenvalue fix, fig.align='center',fig.pos='H'}
#| echo: true
#| message: false
#| warning: false
...
```{r Extend Heteroskedasticity Function Applying, fig.align='center',fig.pos='H'}
#| echo: false
#| message: false
#| warning: false
...
## Function Applying
posterior.exten.hetero = posterior.draws.exten.hetero(total_S = S, Y = Y, X = X) 

A.posterior.ext.het.simu       = posterior.exten.hetero[["A"]][,,(S1+1):S]
Sigma.posterior.ext.het.simu   = posterior.exten.hetero[["Sigma"]][,,(S1+1):S]
Sigma2.posterior.ext.het.simu  = posterior.exten.hetero[["sigma2"]][,(S1+1):S]
```


```{r Mean Sigma of Extended SV Model, fig.align='center',fig.pos='H'}
#| echo: false
#| message: false
#| warning: false

# Presenting output
A.posterior.ext.het.simu.mean = head(round(apply(A.posterior.ext.het.simu, 1:2, mean), 6),11)
Sigma.posterior.ext.het.simu.mean = round(apply(Sigma.posterior.ext.het.simu, 1:2, mean),6)      
```


```{r Mean Sigma of Extended SV Model Output1, fig.align='center',fig.pos='H'}
#| echo: false
#| message: false
#| warning: false
#| tbl-cap: "Table 12 Mean Values of A.posterior.ext.het.simu (head 11)"

kable(A.posterior.ext.het.simu.mean, align = "c") %>% 
  kable_styling(font_size = 8, 
                fixed_thead = TRUE, 
                full_width = FALSE, 
                position = "center",
...
```{r Mean Sigma of Extended SV Model Output2, fig.align='center',fig.pos='H'}
#| echo: false
#| message: false
#| warning: false
#| tbl-cap: "Table 13 Mean Values of Sigma.posterior.ext.het.simu"

kable(Sigma.posterior.ext.het.simu.mean, align = "c") %>% 
  kable_styling(font_size = 8, 
                fixed_thead = TRUE, 
                full_width = FALSE, 
                position = "center",
...
```{r Histograms Trace Plots Extended Hetero, fig.align='center',fig.pos='H'}
#| echo: false
#| message: false
#| warning: false
#| fig-cap: "Figure 16 Histograms and trace plots on key variables using extended hetero model"

par(mfrow=c(2,2), mar=c(4,4,2,2))
plot.ts(A.posterior.ext.het.simu[2,1,], xlab = "Simulation times S", ylab = "lcpi", col = blue3) 
hist(A.posterior.ext.het.simu[2,1,], xlab = "lcpi", col = blue3, main = '')
plot.ts(A.posterior.ext.het.simu[2,2,], xlab = "Simulation times S", ylab = "infexp", col = green3) 
hist(A.posterior.ext.het.simu[2,2,], xlab = "infexp", col = green3, main = '')

```


```{r Extend Model with Hetero Forecasting, fig.align='center',fig.pos='H'}
#| echo: false
#| message: false
#| warning: false
...
h         = 8
N         = ncol(Y) 
Y.h.ext   = array(NA,c(h,N,S)) # for function
S         = 4000
p         = 4

Y.h.ext   = sampling.predictive.density.fun(A.posterior.simu = A.posterior.ext.het.simu,
                                                Sigma.posterior.simu = Sigma.posterior.ext.het.simu,
                                                S = S) 

```

```{r 3d Forecasting Graph on Extend model with Hetero, fig.align='center',fig.pos='H'}
#| echo: false
#| message: false
#| warning: false
#| fig-cap: "Figure 3D forecasting graph on extended model with heteroskedasticity"

# threed.exten.hetero.graph = threed.graph(Y.h = Y.h.ext)

```

```{r 2d forecasting graph on extend model with hetero, fig.align='center',fig.pos='H'}
#| echo: false
#| message: false
#| warning: false
#| fig-cap: "Figure  2D forecasting graph on basic model with heteroskedasticity"

# twod.basic.hetero.graph = twod.graph(Y.h = Y.h.ext)
```

```{r Extend Model with hetero forecast data transform, fig.align='center',fig.pos='H'}
#| echo: false
#| message: false
#| warning: false
...
key.data.h = data.trans(Y.h = Y.h.ext)
```
...
```{r Extended Model with hetero Key Data Plot, fig.align='center',fig.pos='H'}
#| echo: false
#| message: false
#| warning: false
#| fig-cap: "Figure 17 Extended model with heteroskedasticity key data plot"

key.data.exten.hetero.graph = key.data.plot(key.data.h = key.data.h)

```

### Heteroskadasticity Analysis
...
More specifically, the "sigma2.basic" model (black line) shows a more pronounced increase in sigma squared values around time point 120 compared to the "sigma2.heter" model (blue line). This suggests that the basic model may be more sensitive or effective in capturing the variance anomalies at this juncture. This enhanced sensitivity could be attributed to differences in the internal parameter settings or data handling methodologies of the models.
...
```{r Sigma2Plot, fig.align='center',fig.pos='H'}
#| echo: false
#| message: false
#| warning: false
#| fig-cap: "Figure 18 Sigma2 time series plot" 


plot.ts(apply(Sigma2.posterior.ext.het.simu, 1, mean), 
        ylab = "sigma2 values", 
        col = blue4, 
        ylim = range(c(apply(Sigma2.posterior.ext.het.simu, 1, mean), apply(Sigma2.posterior.het.simu, 1, mean))))

lines(apply(Sigma2.posterior.het.simu, 1, mean), col = blue6)

legend("topleft", legend = c("sigma2.ext.heter", "sigma2.basic.heter"), col = c(blue4, blue6), lty = 1)
