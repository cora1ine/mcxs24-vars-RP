...
### Asides - Different Priors and Assumptions
...
According to Bayesian Autoregressions website [@wozniak2023], as $\overline{A}$, $\overline{V}$, $\overline{S}$ and $\overline{v}$ are specified:
...
5.  Draw $\sigma_v^2$ from the inverse gamma distribution, considering the sum of squared differences between successive $H$ values and $h_0$
