...
According to Table 2, we can see that $lcpi_i$, $gold_i$, $lcrt_i$, $lexport_i$, $limport_i$, $lexport_i$require second-order integration, while $gdp_i$, $unemp_i$, $nloan_i$, $aord_i$require first-order integration(under 5% level of confidence.
